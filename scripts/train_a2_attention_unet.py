...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="A2: Attention U-Net + BCE + Dice for BRISC 2025 segmentation")
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("outputs/a2/full"))
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if val_dice > best_dice:
                ...
                torch.save(
                    ...
                    args.out_dir / "checkpoints" / "best_attention_unet.pt",
                )

    save_prediction_figure(model, val_set, device, args.out_dir / "figures" / "sample_prediction.png")
    plot_training_history(history_path, args.out_dir / "figures" / "training_curves.png", "A2 Attention U-Net")
    print(f"saved: {history_path}")
    print(f"saved: {args.out_dir / 'checkpoints' / 'best_attention_unet.pt'}")
