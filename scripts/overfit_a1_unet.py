...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sanity check: overfit A1 U-Net on a tiny BRISC subset")
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("outputs/a1/overfit_8"))
...
def main() -> None:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if eval_dice > best_dice:
                ...
                torch.save(
                    ...
                    args.out_dir / "best_overfit_unet.pt",
                )
    ...
    plot_training_history(history_path, args.out_dir / "overfit_curves.png", "A1 U-Net 8-sample Overfit Check")
    print(f"saved: {history_path}")
    print(f"saved: {args.out_dir / 'best_overfit_unet.pt'}")
